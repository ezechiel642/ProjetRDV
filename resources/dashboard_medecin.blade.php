...
<div class="container-fluid mt-3">
  <div class="row">
    ...
    <div class="col-md-3 sidebar">
      ...
      <div class="menu">
        <a href="#"><i class="bi bi-person-vcard"></i>profil</a>
        <a href="#"><i class="bi bi-person-circle"></i>Mes rendez-vous</a>
        <a href="#"><i class="bi bi-person-circle"></i>gerer mes disponibilites</a>
